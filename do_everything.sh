...
[ -d $prefix/libs/poco-1.8.1 ] || run_cmd get_library poco $prefix/libs
...
[ -d $prefix/libs/octomap-1.6.9 ] || run_cmd get_library octomap $prefix/libs
...
[ -d $prefix/libs/pcre-7.9 ] || run_cmd get_library pcre-7.9 $prefix/libs
...
if [[ $skip -ne 1 ]] ; then
    ...
    # Rospack: remove Python dependency
    apply_patch /opt/roscpp_android/patches/rospack.patch
...
[ -f $prefix/target/lib/libPocoFoundation.a ] || run_cmd build_library_with_toolchain poco $prefix/libs/poco-1.8.1
...
[ -f $prefix/target/lib/liboctomap.a ] || run_cmd build_library octomap $prefix/libs/octomap-1.6.9
[ -f $prefix/target/lib/libyaml-cpp.a ] || run_cmd build_library yaml-cpp $prefix/libs/yaml-cpp
[ -f $prefix/target/lib/libopencv_core.a ] || run_cmd build_library opencv $prefix/libs/opencv-2.4.11
...
[ -f $prefix/target/lib/libpcrecpp.a ] || run_cmd build_library pcrecpp $prefix/libs/pcre-7.9
